...
CuratedSig$Lolli <- LolliPopCols(Data=LogRpkmMeanRel, PointSize=2,
                                                   ...
                                                   Shape=15, GeneSize=7, filterZero=FALSE)+
                                                theme(
...
```{r, collapse=TRUE}
ggsave(plot=CuratedSig$Lolli, filename=paste0(OutputFolder, 'BSpan_LogRpkm.pdf'), width=5, height=10)
ggsave(plot=CuratedSig$Lolli, filename=paste0(OutputFolder, 'BSpan_LogRpkm.png'), width=5, height=10)
```
...
CuratedSig$LolliDelta <- LolliPopCols(LogRpkmDeltaRel, PointSize=4, SegSize=1.5,
                                            ...
                                            unit='DeltaLogRpkm', Shape=18, GeneSize=7, filterZero=FALSE)+
                                                theme(
                                                      legend.text = element_text(size = 12),
                                                      legend.title = element_text(size = 14)
                                                    ) + labs(color = "Pathway")
...
```{r, collapse=TRUE}
ggsave(plot=CuratedSig$LolliDelta, filename=paste0(OutputFolder,  'BSpan_DeltaLogRpkm.pdf'), width=5, height=10)
ggsave(plot=CuratedSig$LolliDelta, filename=paste0(OutputFolder, 'BSpan_DeltaLogRpkm.png'), width=5, height=10)
```
