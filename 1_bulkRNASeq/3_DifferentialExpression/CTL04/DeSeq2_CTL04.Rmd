---
title: "EndPoints hormonal treatment - CTL04"
...
params: 
    ...
    OutputFolder: '~/DataDir/bulkRNASeq/5.DifferentialExpression/CTL04/'
---
 ...
 * Genes modulated considering a threshold of 0.05 on the FDR: `r dim(dplyr::filter(data.frame(Res), padj < 0.05))[1]`
 * Genes modulated considering a threshold of 0.05 on the FDR and of 1.5 on the FC: `r dim(dplyr::filter(data.frame(Res), padj < 0.05, abs(log2FoldChange)>log2(1.5)))[1]`
 * Genes modulated considering a threshold of 0.05 on the FDR and of 2 on the FC: `r dim(dplyr::filter(data.frame(Res), padj < 0.05, abs(log2FoldChange)>1))[1]`
