---
title: "Functional Enrichment analysis with EnrichBrowser for CTL04"
...
output:
    html_document:
        ...
        code_folding: hide
params: 
    DEAListFile: '~/DataDir/bulkRNASeq/5.DifferentialExpression/CTL04/DEARes.rds'
    SE_DEAFile: '~/DataDir/bulkRNASeq/5.DifferentialExpression/CTL04/SE_DEA.rds'
    OutputFolder: NULL  
    Condition_1: ''
    Condition_2: ''
---
...
names(DEA$Estr) <- c("Ag", "Inh", "AgvsInh")
```
